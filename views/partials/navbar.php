...
<div id="header">
<div id='navbar'>
	<a class='nag' href="http://missingonecharecte.dev/">Home</a>
	<?php if(!empty($_SESSION['username']) && Auth::checkUsername($_SESSION['username']) && Auth::check($_SESSION['username'])) { ?>
			<a class='nag' id='logout' href="http://missingonecharecte.dev/logout.php">Log Out</a>
		<?php } else { ?>
			<a  class='nag'id='login' href="http://missingonecharecte.dev/login.php">Login here</a>
			<a class='nag' href="http://missingonecharecte.dev/register.php">Register</a>
		<?php } ?>
	<a class='nag' href="http://missingonecharecte.dev/help.php">Help</a>
